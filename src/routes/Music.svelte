    ...
    let whiteNoises = $state<WhiteNoise[]>([
        {
            ...
            isActive: true,
            data: [
                { id: 136403, name: "Stream Nov", creator: "juskiddink" },
                { id: 827225, name: "Rain", creator: "filmscore" },
                { id: 521772, name: "Rain on rooftop", creator: "mrfossy" },
                { id: 733288, name: "Rain and thunder", creator: "soundrack" },
            ],
        },
        {
            type: "social",
    ...
    <div class="flex flex-col gap-6 overflow-auto no-scrollbar">
        {#each activeWhiteNoises as whiteNoise, i}
            <button
                ...
                onclick={() => (activeWhiteNoise = whiteNoise)}
            >
                <div
