...
>
    <div
        class="flex items-center justify-center shrink-0 flex-col gap-4 w-svw h-svh snap-start snap-always"
    >
        <div
            class="text-(--luxury-white) w-48 h-48 rounded-full p-2.5 relative uppercase"
            style="background: conic-gradient(var(--luxury-white) 0% {100 -
                progressPercent}%, var(--dravit-grey) 0 100%);"
        >
            <div
                class="h-2.5 w-2.5 absolute bg-(--luxury-white) rounded-full left-1/2 top-0 -translate-x-1/2"
            ></div>
            ...
            >
                <div
                    class="h-5 w-5 bg-(--luxury-white) rounded-full -translate-y-1/4"
                ></div>
            </div>
            ...
            >
                <p class="tabular-nums font-features-['calt']">
                    ...
                    {minutes}<span
                        aria-hidden="true"
                        class="text-transparent -ml-[1ch]">P</span
                    >:{seconds}
                </p>
            </div>
        </div>
    ...
    >
        ...
        >
            <div
                class="h-full w-full rounded-full bg-(--blackout) grid place-items-center text-9xl leading-none"
            >
                <p>{minutes}</p>
                <p>{seconds}</p>
            </div>
