...
>
    ...
    <div class="flex items-center justify-center shrink-0 flex-col gap-4 w-svw h-svh snap-start snap-always">
        ...
        <div class="relative flex justify-center gap-10">
            <button onclick={resetTimer} title="Restart session" class="p-3 bg-luxury-white text-blackout rounded-full h-min">
            ...
            <button title="Next session" class="p-3 bg-luxury-white text-blackout rounded-full h-min transition-transform">
