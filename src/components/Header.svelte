...
{#snippet slidingText(text: string)}
    <span
        class="absolute top-1/2 left-1/2 -translate-1/2 text-l tracking-widest"
        in:slide={{ duration: 150, delay: 150 }}
        out:slide={{ duration: 150 }}>{text}</span
    >
{/snippet}

<div
    class="fixed left-0 right-0 top-0 flex justify-between mx-5 my-5 items-center text-(--luxury-white) z-1"
>
    <button
        title="Music"
    ...
    >
        <svg
            ...
            fill="currentColor"
            ><path
                d="M127-167q-47-47-47-113t47-113q47-47 113-47 23 0 42.5 5.5T320-418v-308q0-15 9.5-26.5T353-766l400-66q18-3 32.5 8.5T800-793v433q0 66-47 113t-113 47q-66 0-113-47t-47-113q0-66 47-113t113-47q23 0 42.5 5.5T720-498v-165l-320 63v320q0 66-47 113t-113 47q-66 0-113-47Z"
            /></svg
        >
    </button>
