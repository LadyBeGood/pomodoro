...
<div class="fixed left-0 right-0 top-0 flex justify-between mx-5 my-5 items-center text-luxury-white">
    <button title="" onclick={() => navigate("/music")} class="p-2.5 border-2 rounded-full dark:border-dravit-grey/35 border-dravit-grey/60 bg-blackout">
    ...
    <button title="" onclick={() => navigate("/settings")} class="p-2.5 border-2 rounded-full dark:border-dravit-grey/35 border-dravit-grey/60 bg-blackout">
    ...
    {#if isActive("/")}
        <div class="absolute top-full left-1/2 -translate-x-1/2 flex gap-1.5">
            <div class="scroll-indicator {scrollIndex.value === 1 ? "bg-luxury-white" : "bg-dravit-grey"}"></div>
            <div class="scroll-indicator {scrollIndex.value === 2 ? "bg-luxury-white" : "bg-dravit-grey"}"></div>
        </div>
    {/if}
</div>
