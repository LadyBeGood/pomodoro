...
<div class="fixed left-0 right-0 top-0 flex justify-between mx-5 my-5 text-luxury-white">
    <div class="p-2.5 border-2 rounded-full border-luxury-white/10 bg-blackout">
