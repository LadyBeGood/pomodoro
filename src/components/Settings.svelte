    ...
    <div class="self-end w-full p-6 ">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-4 items-center">
                <a title="Github Repository" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-full bg-blackout text-luxury-white font-bold shadow-lg" href="https://github.com/LadyBeGood/pomodoro">
